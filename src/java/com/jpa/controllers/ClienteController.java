...
import com.jpa.sessions.ClienteFacade;
...
public class ClienteController implements Serializable {
    ...
    @EJB
    private com.jpa.sessions.ClienteFacade ejbFacade;
    ...
    public SelectItem[] getItemsAvailableSelectOne() {
        return getSelectItemsCliente(ejbFacade.findAll(), true);
    }
    
    public static SelectItem[] getSelectItemsCliente(List<Cliente> entities, boolean selectOne) {
